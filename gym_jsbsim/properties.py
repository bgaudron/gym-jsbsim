...
p_radps = BoundedProperty('velocities/p-rad_sec', 'roll rate [rad/s]', float('-inf'), float('+inf'))
q_radps = BoundedProperty('velocities/q-rad_sec', 'pitch rate [rad/s]', float('-inf'), float('+inf'))
r_radps = BoundedProperty('velocities/r-rad_sec', 'yaw rate [rad/s]', float('-inf'), float('+inf'))
